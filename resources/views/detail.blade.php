...
.product-size span, .product-category span {
    font-weight: bold;
    color: #333;
}

.product-size h4, .category-choose {
    font-size: 16px;
    color: #555;
}
...
.review-stars .star-filled {
    filter: brightness(1); /* Ensure filled stars are bright */
}

.review-stars .star {
    filter: grayscale(100%); /* Grey color for empty stars */
}
...
<title>{{ $product->name }} - Détails du produit</title>
   ...
   <div class="left-column">
        ...
        <div class="slider_wrap">
            <div class="slider"> <!-- Ensure .slider is the main class for Slick -->
                @if($product->image1)
