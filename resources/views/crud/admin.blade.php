...
/* Style for text wrapping in name column */
 .text-wrap {
    ...
    overflow-wrap: break-word;    /* Modern, better alternative */
    text-transform: capitalize;   
    width: 50px; /* Set a fixed width for the cell */
}
...
<div class="navbar-logo">
    ...
    <ul class="space-y-2">
        <li>
            <a href="/slider" class="block px-4 py-2 rounded-md text-gray-700 hover:bg-yellow-500 hover:text-white transition">
                Slider
            </a>
        </li>
        <li>
            <a href="/prod" class="block px-4 py-2 rounded-md text-gray-700 hover:bg-yellow-500 hover:text-white transition">
                Produits
            </a>
        </li>
        <li>
            <a href="/panier" class="block px-4 py-2 rounded-md text-gray-700 hover:bg-yellow-500 hover:text-white transition">
                Panier
            </a>
        </li>
        <li>
            ...
            <div class="col-lg-5 col-md-5 col-6">
              <div class="header-left d-flex align-items-center">
                <div class="menu-toggle-btn mr-15">
                  <button id="menu-toggle" class="bg-yellow-500 hover:bg-yellow-600 text-white font-semibold py-2 px-4 rounded transition">
                      ...
                      @auth
                       ...
                       @endauth
                        ...
                        @endauth
                              ...
                              @auth
                                <a class="text-black/40 dark:text-white/40 hover:text-black dark:hover:text-white text-xs fw-500 " href="#">{{ auth()->user()->email }}</a>
                            @endauth
                        </div>
                      </div>
                    </li>
