    ...
    <style>
     ...
     background-color:rgb(255, 255, 255); /* Light grey */
        ...
        .product-description h1 {
            ...
            width: 300px;
            /* ✅ limit width to 100px */
            word-wrap: break-word;
            /* breaks long words */
            white-space: normal;
            /* allows wrapping */
            overflow-wrap: break-word;
            /* ensures consistent breaking */
        }
        ...
        .info-boxes {
            ...
            max-width: 1200px;
            margin: 60px auto;
            /* top/bottom space + horizontal centering */
            justify-items: center;
            /* center each card in its grid cell */
            gap: 50px 40px;
            /* row-gap (50px) and column-gap (40px) */
            padding: 20px;
...
<body>
    ...
    <header class="header-v2">
        ...
        <div class="container-menu-desktop trans-03 ">
            <div class="wrap-menu-desktop">
                <nav class="limiter-menu-desktop p-l-45">
                    ...
                    <!-- Logo desktop -->
                    <a href="/" class="logo">
                        <img src={{asset('logo.svg')}} alt="IMG-LOGO">
                    </a>
        ...
        <div class="wrap-header-mobile fixed top-0 left-0 w-full bg-white z-50 shadow-md flex items-center justify-between px-4 py-2">
            ...
            <!-- Logo mobile -->
            <div class="logo-mobile flex items-center justify-start">
                <a href="/" class="logo">
            ...
            <div class=" text-center">
                ...
                <div class="p-t-40">
                    <p class="stext-107 cl6 txt-center">
                        ...
                        </script> Frip Sakyetna. All rights reserved.
                    </p>
                    <p class="stext-107 cl6 txt-center">
    ...
    <!-- Back to top -->
    <div class="btn-back-to-top m-r-16 " id="myBtn">
